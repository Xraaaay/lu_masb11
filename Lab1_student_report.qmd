...
**Answer**:
<!-- remove this and write your conclusions in simple text -->
The proportion of measurements that are below 80 mg/g is near 0.78.
...
```{r}
m = mean(log(jordprov$ca))
s = sd(log(jordprov$ca))
